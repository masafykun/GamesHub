...
private struct FlagV2Entry {
    let flag: String
    let country: String
}

private struct FlagV2Question {
    let flag: String
...
private class FlagQuizV2ViewModel: ObservableObject {
    @Published var questions: [FlagV2Question] = []
    ...
    private let allFlags: [FlagV2Entry] = [
        FlagV2Entry(flag: "🇯🇵", country: "Japan"),
        FlagV2Entry(flag: "🇺🇸", country: "United States"),
        FlagV2Entry(flag: "🇬🇧", country: "United Kingdom"),
        FlagV2Entry(flag: "🇫🇷", country: "France"),
        FlagV2Entry(flag: "🇩🇪", country: "Germany"),
        FlagV2Entry(flag: "🇮🇹", country: "Italy"),
        FlagV2Entry(flag: "🇨🇳", country: "China"),
        FlagV2Entry(flag: "🇰🇷", country: "South Korea"),
        FlagV2Entry(flag: "🇧🇷", country: "Brazil"),
        FlagV2Entry(flag: "🇦🇺", country: "Australia"),
        FlagV2Entry(flag: "🇨🇦", country: "Canada"),
        FlagV2Entry(flag: "🇷🇺", country: "Russia"),
        FlagV2Entry(flag: "🇮🇳", country: "India"),
        FlagV2Entry(flag: "🇲🇽", country: "Mexico"),
        FlagV2Entry(flag: "🇪🇸", country: "Spain"),
        FlagV2Entry(flag: "🇵🇹", country: "Portugal"),
        FlagV2Entry(flag: "🇳🇱", country: "Netherlands"),
        FlagV2Entry(flag: "🇸🇪", country: "Sweden"),
        FlagV2Entry(flag: "🇨🇭", country: "Switzerland"),
        FlagV2Entry(flag: "🇦🇷", country: "Argentina"),
        FlagV2Entry(flag: "🇿🇦", country: "South Africa"),
        FlagV2Entry(flag: "🇬🇷", country: "Greece"),
        FlagV2Entry(flag: "🇹🇷", country: "Turkey"),
        FlagV2Entry(flag: "🇸🇦", country: "Saudi Arabia"),
        FlagV2Entry(flag: "🇹🇭", country: "Thailand"),
        FlagV2Entry(flag: "🇪🇬", country: "Egypt"),
        FlagV2Entry(flag: "🇳🇬", country: "Nigeria"),
        FlagV2Entry(flag: "🇵🇱", country: "Poland"),
        FlagV2Entry(flag: "🇺🇦", country: "Ukraine"),
        FlagV2Entry(flag: "🇮🇩", country: "Indonesia")
    ]
    ...
    func startQuiz() {
        ...
        for entry in shuffled {
            ...
            generated.append(FlagV2Question(flag: entry.flag, correctAnswer: entry.country, choices: choices))
        }
        questions = generated
        currentIndex = 0
        score = 0
...
struct FlagQuizViewV2: View {
    @StateObject private var vm = FlagQuizV2ViewModel()
    ...
    @ViewBuilder
    private func v2AnswerButton(_ choice: String, question: FlagV2Question) -> some View {
