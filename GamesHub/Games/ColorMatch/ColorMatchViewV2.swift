...
@MainActor
final class ColorMatchViewModelV2: ObservableObject {
...
struct ColorMatchViewV2: View {

    @StateObject private var vm = ColorMatchViewModelV2()
...
struct ColorMatchPlayingView: View {
    @ObservedObject var vm: ColorMatchViewModelV2
