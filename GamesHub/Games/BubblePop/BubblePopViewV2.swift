...
struct BbPBubbleV2: Identifiable {
    let id = UUID()
    var x: CGFloat
    var y: CGFloat
    let color: Color
...
struct BubblePopViewV2: View {
    @State private var bubbles: [BbPBubbleV2] = []
    @State private var score: Int = 0
    @State private var lives: Int = 3
    @State private var phase: BbPPhaseV2 = .start
    ...
    func spawnBubble(in size: CGSize) {
        ...
        let bubble = BbPBubbleV2(x: x, y: size.height + radius, color: color, speed: speed, radius: radius)
