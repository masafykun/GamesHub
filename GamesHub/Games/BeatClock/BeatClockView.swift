...
enum BeatClockPhase { case start, playing, gameOver }

struct BeatClockView: View {
    @State private var phase: BeatClockPhase = .start
    ...
    var v2ClockFace: some View {
        ZStack {
            ...
            // Target arc
            BeatClockArcShape(startDeg: targetStart, endDeg: targetStart + targetWidth)
...
struct BeatClockArcShape: Shape {
    var startDeg: Double
    var endDeg: Double
