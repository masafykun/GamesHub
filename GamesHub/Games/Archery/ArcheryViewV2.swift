...
struct ArcheryViewV2: View {
    @State private var phase: AcV2Phase = .start
    ...
    let rings: [AcV2Ring] = [
        AcV2Ring(radius: 100, color: .white,  points: 2),
        AcV2Ring(radius: 80,  color: .black,  points: 4),
        AcV2Ring(radius: 60,  color: .blue,   points: 6),
        AcV2Ring(radius: 40,  color: .red,    points: 8),
        AcV2Ring(radius: 20,  color: .yellow, points: 10),
    ]
    ...
    var gameOverView: some View {
        VStack(spacing: 24) {
            ...
            VStack(spacing: 8) {
                ...
                Text("out of 100").foregroundStyle(.white.opacity(0.7))
            }
            if difficultyMultiplier > 1.05 {
