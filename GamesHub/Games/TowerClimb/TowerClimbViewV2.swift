...
// MARK: - Models V2
struct TWClV2Platform: Identifiable {
    let id = UUID()
    var x: CGFloat
    var y: CGFloat
    var width: CGFloat
...
// MARK: - TowerClimbViewV2
struct TowerClimbViewV2: View {
    @State private var phase: TWClV2Phase = .start
    ...
    @State private var platforms: [TWClV2Platform] = []
    ...
    func spawnInitialPlatforms() -> [TWClV2Platform] {
        var ps: [TWClV2Platform] = []
        let w = screenSize.width
        let h = screenSize.height
        ps.append(TWClV2Platform(x: w / 2, y: h * 0.65, width: 120))
        var y = h * 0.65 - 110
        while y > -100 {
            ps.append(TWClV2Platform(x: CGFloat.random(in: 60...(w - 60)), y: y, width: platformWidth()))
            y -= 110
        }
        return ps
    }
    ...
    func gameLoop() {
        ...
        if topY > 80 {
            platforms.append(TWClV2Platform(x: CGFloat.random(in: 60...(w - 60)), y: topY - 110, width: platformWidth()))
        }
