...
struct DungeonView: View {
    ...
    @State private var phase: DungeonPhase = .start
    @State private var grid: [[DungeonCell]] = []
    ...
    func buildLevel() {
        var newGrid = Array(repeating: Array(repeating: DungeonCell(type: .empty), count: gridSize), count: gridSize)
        heroPos = (9, 0)
