...
enum FlickHoopsPhase { case start, playing, gameOver }

struct FlickHoopsView: View {
    @State private var phase: FlickHoopsPhase = .start
    @AppStorage("flickHoopsBestScore") private var bestScore: Int = 0
